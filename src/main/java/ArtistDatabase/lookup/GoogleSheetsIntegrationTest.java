...
public class GoogleSheetsIntegrationTest {
    ...
    // otherwise be advised that multiple people may run this lookup and update the public spreadsheet
    private static final String SPREADSHEET_ID = "1Mbspajv-xGj5yFm-PD20cOrqdHEwBJ8nTgO8DwV8z10";
    ...
    public void whenWriteSheet_thenReadSheetOk() throws IOException {
       ...
       // sheetsService.spreadsheets().values().get(SPREADSHEET_ID,"");
        ...
        assertEquals((januaryTotal.getValues().get(0).get(0)),"40");
        ...
        assertTrue((total.getValues().get(0).get(1)).equals("65"));
    }
    ...
    public void whenCreateSpreadSheet_thenIdOk() throws IOException {
        ...
        assertFalse((result.getSpreadsheetId()).isEmpty());
    }
